...
Format: `newappt -id <REFERENCE_ID> -start <START_TIMING> [-end <END_TIMING>] [-rec <INTERVALS> -num <NUMBER_OF_TIMES>]`
...
==== Changes the appointment date: `editeappt` ====
...
Format: `editeappt <ENTRY_ID> -start <START_TIMING> [-end <END_TIMING>]`
...
Format: `editshift <ENTRY_ID> -start <START_TIMING> -end <END_TIMING>`
...
* *Appointment Management* +
** newappt: `appointments [-phone <PATIENT_NAME | PATIENT_IC>] [-rec REPEATEDLY] [-num TIMES]`
...
** editeappt: `editeappt <ENTRY_ID> [-start <START_TIMING>]`
** missappt: `missappt`
** settle: `settle <ENTRY_ID>`

* *Duty-shift Management* +
** newshift: `newshift [-id STAFF_REFERENCE_ID] -start <START_TIMING> -end <END_TIMING> [-rec REPEATEDLY] [-num REPEATED_TIMES]`
** cancelshift: `cancelshift <ENTRY_ID>`
** editshift: `editshift <ENTRY_ID> [-start <START_TIMING>]`
