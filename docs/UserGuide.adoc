...
Format: `enqueue i/<PATIENT_REFERENCE_ID>`
...
Format: `patient [i/<PATIENT_REFERENCE_ID | n/PATIENT_NAME | p/PHONE_NUM>]`

==== Registers a new patient: `register` ====

Registers a new patient +
Format:  `register n/<PATIENT_NAME> i/<PATIENT_REFERENCE_ID> p/<PHONE_NUM> e/<EMAIL>] [a/<ADDRESS>] [r/<REMARK>]`
...
Format: `update <ENTRY_ID> [n/<PATIENT_NAME>] [i/<PATIENT_REFERENCE_ID>] [p/<PHONE_NUM>] [e/<EMAIL>] [a/<ADDRESS>] [r/<REMARK>]`
...
Format: `newdoctor n/<DOCTOR_NAME> [p/<PHONE_NUM>] +
 [e/<EMAIL>] [r/<REMARK>]`
...
Format: `appointments [i/<PATIENT_REFERENCE_ID>] [str/<START_DATE>] [end/<END_DATE>]`
...
Format: `change <ENTRY_ID> [i/<PATIENT_REFERENCE_ID>] [str/<START_DATE>] [end/<END_DATE>]`

==== Shows the empty slots: `slot` ====

List all the available empty slots for patients to make appointments +
Format: `slot str/<START_DATE> end/<END_DATE>`
