...
Format: `patient [i/<PATIENT_REFERENCE_ID | n/PATIENT_NAME | PHONE_NUM>]`
...
Format: `appointments [-i <PATIENT_REFERENCE_ID>] [-start|-s <START_DATE>] [-end|-e <END_DATE>]`
...
Format: `change <ENTRY_ID> [-i <PATIENT_REFERENCE_ID>] [-start|-s <START_DATE>] [-end|-e <END_DATE>]`
